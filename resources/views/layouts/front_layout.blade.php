            ...
            <div class="row">
                <div class="col">
                    <div
                        ...
                        <div class="footer_logo"><a href="#">{{ config('app.name') }}.</a></div>

                        <div class="footer_social ml-lg-auto">
                            <ul>
                                <li><a href="https://www.instagram.com/babycomfort_uz/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                <li><a href="https://t.me/babycomfort_uz"><i class="fa fa-telegram" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
